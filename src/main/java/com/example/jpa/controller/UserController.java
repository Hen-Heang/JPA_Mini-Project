...
//import com.example.jpa.service.user.UserBankingService;
...
//    private final UserBankingService userService;
//
//    @PostMapping("/add")
//    public Object createUser(@RequestBody UserRequest userRequest) {
//        if (userRequest.getName() == null || userRequest.getName().isBlank()) {
//            throw new IllegalArgumentException("UserBanking can not be blank");
//        }
